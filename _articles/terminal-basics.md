...
To navigate a manual, you can use the <kbd>↑</kbd> and <kbd>↓</kbd> arrow keys, or the <kbd>Page Up</kbd> and <kbd>Page Down</kbd> keys. To quit a manual, press the <kbd>Q</kbd> key.
